...
const COLOR_CODES = {
  ...
  let deadline = new Date(current_time + result * 60 * 1000);
    ...
    let a = Date.parse(deadline);
    let b = Date.parse(new Date());
    let TIME_LIMIT = (a - b)/1000;
    console.log(TIME_LIMIT/1000);
...
<div class="base-timer">
  ...
  <span id="base-timer-label" class="base-timer__label">${t.hours + t.minutes + t.seconds}</span>
</div>
`;
      timePassed = timePassed += 1;
      console.log(TIME_LIMIT);
      timeLeft = TIME_LIMIT - timePassed;
      document.getElementById("base-timer-label").innerHTML = t.hours + ":" +t.minutes + ":" + t.seconds;
      setCircleDasharray();
